...
class AccessTokenTest extends TestCase {
    ...
    public function can_create_access_token()
    {
        ...
        $token = new \OPENLOGI\Salesforce\AccessToken(
            'abc123',
            $issueDate,
            $expiryDate,
            ['scopes'],
        ...
        $this->assertInstanceOf(\OPENLOGI\Salesforce\AccessToken::class, $token);
    ...
    {
        $token1 = new \OPENLOGI\Salesforce\AccessToken(
            'abc123',
            \Carbon\Carbon::now(),
        ...
        $token2 = new \OPENLOGI\Salesforce\AccessToken(
            'abc123',
