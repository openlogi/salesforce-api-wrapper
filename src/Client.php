...
use OPENLOGI\Salesforce\Exceptions\AuthenticationException;
use OPENLOGI\Salesforce\Exceptions\RequestException;
...
class Client
{
    ...
    /**
     * @var \OPENLOGI\Salesforce\AccessTokenGenerator
     */
     ...
     * @param \OPENLOGI\Salesforce\AccessTokenGeneratorInterface $accessTokenGenerator
     */
     ...
     *
     * @return AccessToken
     * @throws \OPENLOGI\Salesforce\Exceptions\AuthenticationException
     * @throws \OPENLOGI\Salesforce\Exceptions\RequestException
     */
